...
En la tercera terminal dirigirse al directorio que contiene el workspace de catkin y escribir source devel/setup.bash. Acto seguido escribir rosrun hello turtle myTeleopKey.py. En este punto, la terminal ya debería estar esperando el ingreso de teclas.
...
Se presentará a continuación el código implementado, junto con videos que demuestren la implementación de ese mismo código.
